...
PGPASSWORD=postgres psql -U postgres -h localhost -f scripts/cluster_datapoints.sql sfpark
...
PGPASSWORD=postgres psql -U postgres -h localhost -f scripts/model_errortype.sql sfpark
...
sh scripts/model_results_source_method.sh 'dt' | PGPASSWORD=postgres psql -U postgres -h localhost sfpark
...
sh scripts/model_results_source_method.sh 'svm' | PGPASSWORD=postgres psql -U postgres -h localhost sfpark
...
sh scripts/model_results_source_method.sh 'mlp' | PGPASSWORD=postgres psql -U postgres -h localhost sfpark
...
sh scripts/model_results_source_method.sh 'xgb' | PGPASSWORD=postgres psql -U postgres -h localhost sfpark
...
sh scripts/model_results_source_method_best.sh | PGPASSWORD=postgres psql -U postgres -h localhost sfpark
...
sh scripts/model_results_target_method.sh 'dt' | PGPASSWORD=postgres psql -U postgres -h localhost sfpark
...
sh scripts/model_results_target_method.sh 'svm' | PGPASSWORD=postgres psql -U postgres -h localhost sfpark
...
sh scripts/model_results_target_method.sh 'mlp' | PGPASSWORD=postgres psql -U postgres -h localhost sfpark
...
sh scripts/model_results_target_method.sh 'xgb' | PGPASSWORD=postgres psql -U postgres -h localhost sfpark
...
sh scripts/model_results_target_method_best.sh | PGPASSWORD=postgres psql -U postgres -h localhost sfpark
