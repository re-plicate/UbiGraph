...
if __name__ == "__main__":
    ...
    for index in range(0, len(cwout_results.index), 1):
        ...
        for i in range(0, len(cwithids)):
            ...
            #filename = '/Users/tangyuanzong/Desktop/parking-estimator/workspace/parking-estimator/persisted/clusterId2_xgb.pkl'
