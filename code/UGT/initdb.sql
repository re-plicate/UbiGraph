...
\copy blocks FROM 'scripts/osm/mask_SFpark_Blocks.csv' DELIMITER ',' CSV HEADER
SET datestyle=DMY;
...
\copy occupancy FROM 'scripts/osm/occupancy_030917_final.csv' DELIMITER ',' CSV HEADER
...
DROP TABLE IF EXISTS poi_reduced;
...
DROP TABLE IF EXISTS merge_block_poi;
...
DROP TABLE IF EXISTS cluster_cosine_vectors;
...
DROP TABLE IF EXISTS cluster_emd_gaussians;
...
DROP TABLE IF EXISTS cluster_similarity;
