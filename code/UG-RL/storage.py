...
class RolloutStorage(object):
    def __init__(self, num_steps, mini_batch_num, obs_shape, uav_num,poi_data_shape,
        ...
        self.cur_poi_data_val = torch.zeros(num_steps + 1, poi_data_shape)
    ...
    def to(self, device):
        ...
        self.cur_poi_data_val =self.cur_poi_data_val.to(device)
    ...
    def insert(self, obs, uav_aoi, uav_snr, uav_tuse, uav_effort,cur_poi_data_val, actions, action_log_probs, value_preds, rewards,
        ...
        self.cur_poi_data_val[self.step + 1].copy_(cur_poi_data_val.squeeze())
    ...
    def after_update(self, obs, uav_aoi, uav_snr, uav_tuse, uav_effort,cur_poi_data_val):
        self.step = 0
        ...
        self.cur_poi_data_val[0].copy_(cur_poi_data_val.squeeze())
    ...
    def feed_forward_generator(self, advantages):
        ...
        for indices in sampler:
            ...
            cur_poi_data_val_batch = self.cur_poi_data_val[indices]
            ...
            yield obs_batch, uav_aoi_batch, uav_snr_batch, uav_tuse_batch, uav_effort_batch,cur_poi_data_val_batch, action_dia_batch, \
    ...
    def rnn_feed_forward_generator(self, advantages):
        ...
        for indices in sampler:
            ...
            for t in range(1, params.rnn_seq_len):
                ...
                cur_poi_data_val_batch_i = self.cur_poi_data_val[cur_index]
                ...
                if t == 1:
                    ...
                    cur_poi_data_val_batch = torch.stack((cur_poi_data_val_batch,cur_poi_data_val_batch_i))
                    ...
                    cur_poi_data_val_batch = torch.cat((cur_poi_data_val_batch, cur_poi_data_val_batch_i.unsqueeze(0)),dim=0)
            ...
            cur_poi_data_val_batch = _flatten_helper(T, N, cur_poi_data_val_batch)
